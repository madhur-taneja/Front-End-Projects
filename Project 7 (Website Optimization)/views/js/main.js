...
// Minified js for these arrays from https://javascript-minifier.com/
...
var resizePizzas = function(size) {
  ...
  // Storing .randomPizzaContainer in a variable
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // Reducing no. of times the loop runs to render page faster as images will be created lesser times.
  var res = ((screen.height) / s) * cols;
  for (var i = 0; i < res; i++) {
